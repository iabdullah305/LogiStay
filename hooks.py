...
# fixtures are not used in strict code-only mode
...
app_include_css = "/assets/fleet_management/css/fleet_theme.css?v=" + str(time.time())
# app_include_js = "/assets/fleet_management/js/fleet_management.js"

# include js, css files in header of web template
web_include_css = "/assets/fleet_management/css/fleet_theme.css?v=" + str(time.time())
# web_include_js = "/assets/fleet_management/js/fleet_management.js"

# include custom scss in every website theme (without file extension ".scss")
# website_theme_scss = "fleet_management/public/css/fleet_theme"
